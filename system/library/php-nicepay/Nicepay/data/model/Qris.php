...
class QrisBuilder
{
    ...
    public function setPartnerReferenceNo($partnerReferenceNo): QrisBuilder
    {
    ...
    public function setMerchantId($merchantId): QrisBuilder
    {
    ...
    public function setValidityPeriod($validityPeriod): QrisBuilder
    {
