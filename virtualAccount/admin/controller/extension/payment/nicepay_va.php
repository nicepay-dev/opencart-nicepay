...
class ControllerExtensionPaymentNICEPayVA extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['payment_nicepay_va_merchant_key'])) {
			$data['payment_nicepay_va_merchant_key'] = $this->request->post['payment_nicepay_va_merchant_key'];
		} else {
			$data['payment_nicepay_va_merchant_key'] = $this->config->get('payment_nicepay_va_merchant_key');
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['payment_nicepay_va_merchant_key']) {
